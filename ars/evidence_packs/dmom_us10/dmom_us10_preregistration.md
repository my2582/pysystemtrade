...
| Cell | Variant | Notes |
|---|---|---|
| cell-0 (baseline) | Martin 6-speed EWMAC, equal-weight, carry off, soft cap 20, vol target 20%, $50k, integer contracts | from `ars/evidence_packs/martin_single_instrument/` (US10 + SP500) |
