...
**Owner pre-registration sign-off**: 2026-05-29 by <owner>; grandfathered as Path Z (post-hoc) under `ars/PROMOTION.md`.
...
Constants (ex-ante): `capital_usd=<capital-token>`, `vol_target_pct=20.0`, `forecast_cap=20.0`, `carry_included=false`, `idm=1.0`, `roundpositions=true`.
